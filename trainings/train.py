...
parser.add_argument('--batch_size', type=int, default=24, help='number of batch size to train')
...
if args.loadmodel is not None:
    ...
    for param in model.module.outN_block.parameters():
        param.requires_grad = True
    for param in model.module.maskFt_block.parameters():
        param.requires_grad = True
    model.load_state_dict(model_dict)
optimizer = optim.Adam([{'params':model.module.maskFt_block.parameters()},
                        {'params':model.module.outC_block.parameters()},
